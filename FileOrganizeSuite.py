...
def copy_files(source_dir, dest_dir, extensions, category):
    global duplicate_files  # Declare global variable to be used within this function
...
def select_file_types():
    ...
    while True:
        ...
        try:
            ...
            if choice == 7:
                upgrade_script()
                return None  # After upgrade, we don't proceed further in this loop
            ...
            # If valid choices are made or 'Select all files' is chosen, break loop
...
def handle_duplicates():
    global duplicate_files, duplicates_detected  # Declare global variables
...
def main():
    ...
    while True:
        ...
        if selected_categories is None:
            # Exit or upgrade has been selected
            return
        ...
        while True:
            ...
            if option == "1":
                ...
                if duplicate_files:
                    ...
                    exit_duplicate = input("Would you like to handle it (y/n): ").strip().lower()
                    if exit_duplicate == 'y':
                        handle_duplicates()
                handle_exit()
            else:
